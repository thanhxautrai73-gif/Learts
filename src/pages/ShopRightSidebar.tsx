...
export const ShopRightSidebar: React.FC = () => {
      ...
      >
        <div className="container">
          <div className="page-title">
            <h1 className="title" style={{ fontFamily: 'var(--font-serif)', color: '#111' }}>Shop Right Sidebar</h1>
            <ul className="breadcrumb">
              <li className="breadcrumb-item"><a href="/">Home</a></li>
              <li className="breadcrumb-item active">Shop Right Sidebar</li>
            </ul>
          </div>
        </div>
      </div>
        ...
        <div className="container">
          <div className="row g-4">
            ...
            <div className="col-lg-3 col-12 order-lg-2">
              <div className="widgets" style={{ marginLeft: '15px' }}>
                {/* Search Widget */}
